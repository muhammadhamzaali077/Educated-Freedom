/**
 * Icon registry. Path data lifted verbatim from Lucide (ISC license).
 * Stroke / viewBox / linecap are applied at the SVG level by the Icon
 * component — keep entries to inner paths only.
 *
 * Add new icons by name; do not mix icon sets (CLAUDE.md §5).
 */
